...
public class RotationAnimator_Randomized : MonoBehaviour
{
    ...
    void Awake()
    {
        f = Random.Range(0, random_factor);
    }
...
//        RotationManager.Singleton().RegisterRotator(this);
    ...
    public void Update()
    {
        if(isActive)
        {
            ...
            objectToRotate.Rotate(GetDirection() * rotationSpeed * dt * f, space);
        }
    }
}
